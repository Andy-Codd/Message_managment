...
$numero_enfants = $_SESSION['numE'];
$sim_enfant = $_SESSION['simE'];
...
<body>
        ...
        <h1 style="text-align: center;">Les messages seront envoyés aux enfants si vous avez un forfait dans votre telephone</h1>
